...
/** @brief Temp_IMU Characteristic UUID. */
#define Temp_IMU_UUID_VAL \
	BT_UUID_128_ENCODE(0x00001525, 0x1212, 0xefde, 0x1523, 0x785feabcd123)
/** @brief Temp_Body_Position Characteristic UUID. */
#define Temp_BODY_POSITION_UUID_VAL \
...
#define Temp_IMU_UUID         			BT_UUID_DECLARE_128(Temp_IMU_UUID_VAL)
#define Temp_BODY_POSITION_UUID         BT_UUID_DECLARE_128(Temp_BODY_POSITION_UUID_VAL)
...
typedef bool (*temp_IMU_t)(void);

/** @brief Callback struct used by the LBS Service. */
struct bt_lbs_cb {
	/** LED state change callback. */
	led_cb_t    led_cb;
	/** ECG Data read callback. */
	button_cb_t button_cb;
	/** Tem IMU read callback. */
	temp_IMU_t temp_imu_cb;
};
